...
data "aws_ssm_parameter" "authorize_host" {
  name = "/lab/microsservices/authorize-host"
}
data "aws_ssm_parameter" "authorize_port" {
  name = "/lab/microsservices/authorize-port"
}

data "aws_ssm_parameter" "token_host" {
  name = "/lab/microsservices/token-host"
}

data "aws_ssm_parameter" "token_port" {
  name = "/lab/microsservices/token-port"
}
